...
const translations = {
    ko: {
        ...
        tarot_info_title: "타로 카드 가이드",
        tarot_info_body: "타로는 78장의 카드로 구성된 상징 체계입니다. 22장의 메이저 아르카나는 삶의 큰 흐름과 영적 여정을, 56장의 마이너 아르카나는 일상의 구체적인 상황을 나타냅니다. 카드를 뽑기 전 잠시 마음을 가다듬고 오늘 하루에 집중해 보세요.",
        tarot_suits_title: "마이너 아르카나 4수트",
        tarot_suit_wands: "🪄 지팡이(Wands) — 열정·의지·창조력. 불의 원소.",
        tarot_suit_cups: "🍷 컵(Cups) — 감정·관계·직관. 물의 원소.",
        tarot_suit_swords: "⚔️ 검(Swords) — 이성·갈등·진실. 공기의 원소.",
        tarot_suit_pentacles: "💰 펜타클(Pentacles) — 물질·안정·현실. 땅의 원소.",
    ...
    en: {
        ...
        tarot_info_title: "Tarot Card Guide",
        tarot_info_body: "Tarot is a symbolic system of 78 cards. The 22 Major Arcana represent life's grand themes and spiritual journey, while the 56 Minor Arcana reflect everyday situations. Before drawing, take a moment to quiet your mind and focus on today.",
        tarot_suits_title: "Minor Arcana — 4 Suits",
        tarot_suit_wands: "🪄 Wands — Passion, willpower, creativity. Element of Fire.",
        tarot_suit_cups: "🍷 Cups — Emotions, relationships, intuition. Element of Water.",
        tarot_suit_swords: "⚔️ Swords — Reason, conflict, truth. Element of Air.",
        tarot_suit_pentacles: "💰 Pentacles — Material, stability, reality. Element of Earth.",
    ...
    ja: {
        ...
        tarot_info_title: "タロットカードガイド",
        tarot_info_body: "タロットは78枚のカードで構成された象徴体系です。22枚のメジャーアルカナは人生の大きなテーマと精神的な旅を、56枚のマイナーアルカナは日常の具体的な状況を表します。カードを引く前に、心を落ち着けて今日一日に集中してみましょう。",
        tarot_suits_title: "マイナーアルカナ 4スート",
        tarot_suit_wands: "🪄 ワンド — 情熱・意志・創造力。火のエレメント。",
        tarot_suit_cups: "🍷 カップ — 感情・関係・直感。水のエレメント。",
        tarot_suit_swords: "⚔️ ソード — 理性・葛藤・真実。風のエレメント。",
        tarot_suit_pentacles: "💰 ペンタクル — 物質・安定・現実。地のエレメント。",
