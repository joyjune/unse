...
async function updateFortune(type) {
    ...
    if (type === 'constellation') {
        ...
        if (myFortune) {
            ...
            const luckColorEl = document.getElementById('luck-color');
            const luckColorP = luckColorEl.parentElement;
            if (!color || color === '-') {
                luckColorP.style.display = 'none';
            } else {
                luckColorP.style.display = '';
                luckColorEl.innerText = color;
            }
        } else {
